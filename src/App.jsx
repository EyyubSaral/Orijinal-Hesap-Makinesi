...
Hesap makinesinin çalışmasını sağlamak için *sadece* aşağıdaki üç görevi tamamlamanız ve her görev için *sadece* geçerli currentCalc state'ini güncellemeniz gerekir! */
    ...
    if (numFromClick) {
      ...
      a. numFromClick değeri, currentCalc'ın currentNum array'inin sonuna eklenmeli ve array'de zaten kayıtlı olan değerler korunmalıdır. [currentNum, previousNum, operation, result]
...
---------------Aşağıdaki 1. görev için kodunuzu yazın.------------------------------------------------*/
      ...
      b. currentCalc'ın diğer tüm özellikleri, b INITIAL_STATE (yukarıdaki 9. satır) içinde kaydedilen ilk değerlerine geri döndürülmelidir. [currentNum, previousNum, operation, result]
